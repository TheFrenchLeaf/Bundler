...
int				ann_1_1_char::ann_Ndata_pts  = 0;		// number of data points
int				ann_1_1_char::ann_Nvisit_lfs = 0;		// number of leaf nodes visited
int				ann_1_1_char::ann_Nvisit_spl = 0;		// number of splitting nodes visited
int				ann_1_1_char::ann_Nvisit_shr = 0;		// number of shrinking nodes visited
int				ann_1_1_char::ann_Nvisit_pts = 0;		// visited points for one query
int				ann_1_1_char::ann_Ncoord_hts = 0;		// coordinate hits for one query
int				ann_1_1_char::ann_Nfloat_ops = 0;		// floating ops for one query
ANNsampStat		ann_1_1_char::ann_visit_lfs;			// stats on leaf nodes visits
ANNsampStat		ann_1_1_char::ann_visit_spl;			// stats on splitting nodes visits
ANNsampStat		ann_1_1_char::ann_visit_shr;			// stats on shrinking nodes visits
ANNsampStat		ann_1_1_char::ann_visit_nds;			// stats on total nodes visits
ANNsampStat		ann_1_1_char::ann_visit_pts;			// stats on points visited
ANNsampStat		ann_1_1_char::ann_coord_hts;			// stats on coordinate hits
ANNsampStat		ann_1_1_char::ann_float_ops;			// stats on floating ops
//
ANNsampStat		ann_1_1_char::ann_average_err;		// average error
ANNsampStat		ann_1_1_char::ann_rank_err;			// rank error
