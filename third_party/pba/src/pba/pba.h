...
public:
    ...
    PBA_EXPORT virtual void SetFocalLengthFixed(bool fixed);             //call this for calibrated system
...
PBA_EXPORT_EXTERN ParallelBA * NewParallelBA(ParallelBA::DeviceT device 
                                                = ParallelBA::PBA_CUDA_DEVICE_DEFAULT);
