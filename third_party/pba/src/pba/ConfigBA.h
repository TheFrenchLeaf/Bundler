...
#ifndef CONFIG_GPU_SBA_H
#define CONFIG_GPU_SBA_H
...
public:
    ...
    float   __lm_mse_threshold;          //(default 0.5) quit if MSE is equal to or smaller than this
    ...
    bool    __fixed_focallength;         //(default false) set true for calibrated camera system
    int     __use_radial_distortion;     //(default 0, 1 for projection distortion, 2 for measurement distortion)
    bool    __reset_initial_distortion;  //(default false) reset the initial distortion to 0
    ...
    ///////////////////////////////////
    bool    __jacobian_normalize;        //(default false) scaling the jacobians according to initial jacobians
